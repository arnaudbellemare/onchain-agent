    ...
    <div className="flex items-center space-x-2">
      ...
      <div className="flex items-center space-x-2 bg-gray-100 px-3 py-2 rounded-lg border border-gray-200">
        ...
        <div className="text-xs text-gray-500">
          {balance ? `${parseFloat(balance.formatted).toFixed(2)} ${balance.symbol}` : '0 ETH'}
        </div>
      </div>
      ...
      <button
        onClick={logout}
        className="bg-gray-200 hover:bg-gray-300 text-gray-700 px-2 py-1 rounded text-xs transition-all duration-200"
      >
        Disconnect
      </button>
    </div>
